...
Do not run any local Python executions, as local Python environments are not used in this workstation
...
This folder is a Project that entails various repositories.
...
This document is a living summary of the full Project. It should help future coding agents quickly understand the project before making changes.
